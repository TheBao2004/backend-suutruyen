                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h6 class="mb-4">Danh sách chương</h6>
                            </div>
                            <div>
                                <a class="btn btn-primary" href="{{ route('admin.chap.add', ['comic' => $comic]) }}">
                                    Thêm
                                </a>
                            </div>
                        </div>
                            ...
                            <table class="table table-dark" id="table_seven">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="">Tên chương</th>
                                ...
                                <tbody>
                                    ...
                                    {{-- @for ($i = 0; $i < 10; $i++) --}}
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.chap.edit', ['item' => $item]) }}" class="btn btn-warning">Sửa</a>
                                                |
